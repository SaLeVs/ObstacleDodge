#ifndef ALLIN13DSHADER_PROPERTIESDECLARATION
#define ALLIN13DSHADER_PROPERTIESDECLARATION

#if defined(INSTANCING_ON) && !defined(PROCEDURAL_INSTANCING_ON) && !defined(UNITY_DOTS_INSTANCING_ENABLED)
	#define ALLIN13D_GPU_INSTANCING
#endif

#if defined(UNITY_DOTS_INSTANCING_ENABLED)
	#define BATCHING_BUFFER_START	UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata) 
	#define BATCHING_BUFFER_END		UNITY_DOTS_INSTANCING_END(MaterialPropertyMetadata)
...
#elif defined(PROCEDURAL_INSTANCING_ON)
...
#endif //ALLIN13DSHADER_PROPERTIESDECLARATION